  ...
  <div class="products-section">
    ...
    <div class="products-grid">
      <div v-for="(produit, index) in filteredProducts" :key="index" class="product">
        <svg v-if="!isFavorite(produit) || groupe != 'USER'" @click="toggleFavorite(produit)" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
